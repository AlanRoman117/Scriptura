...
Jest with ts-jest. Config in root `jest.config.ts`. **329 jest tests, plus 300 Playwright** (47 contract, 192 reader, 59 reader-touch, 2 reader-dev).
