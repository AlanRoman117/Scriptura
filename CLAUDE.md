...
Jest with ts-jest. Config in root `jest.config.ts`. **329 jest tests, plus 315 Playwright** (47 contract, 202 reader, 64 reader-touch, 2 reader-dev).
