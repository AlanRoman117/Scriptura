...
export const jaJP = {
  ...
  previewBuild: {
    ...
    about:
      'この版は、スペイン語・フランス語・日本語の画面表示を確認していただく方のためのものです。ここでの操作内容はどこにも送信されません。ノートとマークはこのブラウザーの中に残ります。誤りやわかりにくい言葉を見つけたら、下のリンクから報告してください。GitHubの短いフォームが開きます（無料のアカウントが必要です）。',
